...
import (
	...
	mycrdv1 "k8sCRD/pkg/apis/mycrd/v1"
	clientset "k8sCRD/pkg/client/clientset/versioned"
	networkscheme "k8sCRD/pkg/client/clientset/versioned/scheme"
	informers "k8sCRD/pkg/client/informers/externalversions/mycrd/v1"
	listers "k8sCRD/pkg/client/listers/mycrd/v1"
...
func NewController(
	...
	networkInformer.Informer().AddEventHandler(cache.ResourceEventHandlerFuncs{
		...
		UpdateFunc: func(old, new interface{}) {
			oldNetwork := old.(*mycrdv1.Network)
			newNetwork := new.(*mycrdv1.Network)
