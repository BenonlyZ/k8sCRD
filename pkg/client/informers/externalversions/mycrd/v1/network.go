...
import (
	...
	versioned "k8sCRD/pkg/client/clientset/versioned"
	internalinterfaces "k8sCRD/pkg/client/informers/externalversions/internalinterfaces"
	v1 "k8sCRD/pkg/client/listers/mycrd/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.MycrdV1().Networks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MycrdV1().Networks(namespace).Watch(context.TODO(), options)
			},
		},
		&mycrdv1.Network{},
		resyncPeriod,
...
func (f *networkInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mycrdv1.Network{}, f.defaultInformer)
}
